...
class BedLeveling:
	...
	def set_mesh_dist(grid_max_points_x, grid_max_points_y):
		...
		for x in range(int(grid_max_points_x)):
			...
			if BedLeveling.grid_max_x - px < BedLeveling.X_PROBE_OFFSET_FROM_EXTRUDER:
				px = BedLeveling.grid_max_x - px - 1
		...
		for y in range(int(grid_max_points_y)):
			...
			if BedLeveling.grid_max_y - py < BedLeveling.Y_PROBE_OFFSET_FROM_EXTRUDER:
				py = BedLeveling.grid_max_y - py - 1
