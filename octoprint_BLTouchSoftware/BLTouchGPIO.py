...
class BLTouchGPIO:
	...
	def __init__(self):
		...
		GPIO.add_event_detect(self.GPIO_BLTouch_Zmin, GPIO.FALLING, callback=self.callback_bltouch_zmin, bouncetime=200)
	...
	def callback_bltouch_zmin(self, channel):
		if GPIO.input(channel):
			...
			self.printlog("BLTOUCH NOISE?! channel=%s" % channel)
